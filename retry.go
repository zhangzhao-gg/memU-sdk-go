/**
 * [INPUT]: 依赖 time 的 Duration; 依赖 net/http 的 Response
 * [OUTPUT]: 对外提供 RetryPolicy, RetryConfig, DefaultRetryPolicy, NoRetryPolicy, CustomRetryPolicy 类型
 * [POS]: SDK 根目录的重试策略层，定义重试行为配置，被 client.go 和 options.go 消费
